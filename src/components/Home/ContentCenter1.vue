  ...
  <div class="contentCenter">
    <div class="contentCenter_Left">
      ...
      <div class="contentCenter_Left_item">
        ...
        <div v-show="this.guanbi" class="fugai">
          <div class="fugai_left">
            <div class="fugai_left_product">
              ...
              <div class="fugai_left_item" >
                <a href="" v-for="(item,index) in this.chufangdianqi" :key="index">
                  {{item.name}}
                </a>
              </div>
            </div>
        ...
        <div v-show="!this.guanbi" class="contentCenter_Left_item_content">
          ...
          <div class="contentCenter_Left_item_content_bottom">
            <div class="contentCenter_Left_item_content_bottom_image1">
              ...
              <div class="image">
                <img src="https://gw.alicdn.com/imgextra/i3/O1CN01tvhWFR20c3IBJxfuu_!!6000000006869-0-tps-640-240.jpg_Q75.jpg" alt="" />
              </div>
            </div>
            <div class="contentCenter_Left_item_content_bottom_image1">
              <div class="wenzi">
              ...
              <div class="image">
                <img src="https://gw.alicdn.com/imgextra/i4/O1CN01P9Ttk11JWzR4bqA5X_!!6000000001037-0-tps-640-240.jpg_Q75.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
